...
def each_gbdt(fileName):
	...
	for i in range(6): 
		...
		train_x_1 = np.hstack((train_x01,train_x02))  #合并特征数组
	...
	resultDF.to_csv(fileName+'_morning_predict_0521_v4.csv')
	resultDF_2.to_csv(fileName+'_afternoon_predict_0521_v4.csv')
