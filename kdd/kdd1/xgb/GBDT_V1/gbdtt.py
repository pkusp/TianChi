...
def each_gbdt(fileName):
	...
	resultList=list(resultArr[:,0])+list(resultArr[:,1])+list(resultArr[:,2])+list(resultArr[:,3])+list(resultArr[:,4])+list(resultArr[:,5])
	...
	resultList_2=list(resultArr_2[:,0])+list(resultArr_2[:,1])+list(resultArr_2[:,2])+list(resultArr_2[:,3])+list(resultArr_2[:,4])+list(resultArr_2[:,5])
	...
	resultDF.to_csv(fileName+'_morning_predict_0520.csv')
	resultDF_2.to_csv(fileName+'_afternoon_predict_0520.csv')
